...
public class HRMS_Test {
  public static void main(String[] args) throws InterruptedException {
    ...
    driver.findElement(By.xpath(HRMS_LoginPage.Screen.txtBoxUsername)).sendKeys("ptqanh");
    driver.findElement(By.xpath(HRMS_LoginPage.Screen.txtBoxPassword)).sendKeys("123456a@");
    driver.findElement(By.xpath(HRMS_LoginPage.Screen.btnLogin)).click();
//    Thread.sleep(5000);
//    driver.close();
//    driver.quit();
  }
